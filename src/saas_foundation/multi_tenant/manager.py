...
class MultiTenantManager:
    ...
    def get_account_by_id(self, account_id: int) -> Account | None:
        ...
        if account_data:
            ...
            return Account(id=account_data['id'], name=account_data['name'], created_at=account_data.get('created_at'))
        return None
    ...
    def generate_reset_token(self, username: str) -> str | None:
        ...
        if user_data:
            ...
            self.datastore.update("users", user_data["id"], {
                "reset_token": token,
    ...
    def reset_password(self, username: str, token: str, new_password: str) -> bool:
        ...
        if user_data and user_data.get("reset_token") == token:
            token_created_at = self._convert_timestamp_to_datetime(user_data.get("reset_token_created_at"))
            if token_created_at and datetime.now(timezone.utc) - token_created_at < timedelta(hours=1):
